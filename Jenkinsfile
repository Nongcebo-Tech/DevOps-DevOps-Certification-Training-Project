node {
    ...
    def dockerhubaccountid = "ngcebotech"
    ...
    stage('Clone Repo') { 
      ...
      git url:'https://github.com/Nongcebo-Tech/DevOps-DevOps-Certification-Training-Project.git',branch:'main' //update your forked repo
      // Get the Maven tool.
